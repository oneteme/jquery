...
public final class TreemapChartView implements ResultWebView {
    ...
    public Void map(ResultSet rs) throws SQLException {
		...
		var xCols = columns(rs.getMetaData(), not(yCols.getKey()::equals)); //TODO 2 required columns
		...
		try {
			writer.write(readString(Paths.get(getClass().getResource("./treemap.google.html").toURI()))
